            ...
            { project.display &&
                <div 
                    ...
                    <div className="d-flex flex-column">
                        ...
                        <p className="project-name">{project.projectName.toUpperCase()}</p>
                        <p className="project-desc mx-4 mb-5">{project.projectDesc}</p>
                        <button className={`btn btn-outline-light mx-4 mt-2 mb-4 display-none`} onClick={() => navigateToProject(project.projectLink)}>View Project</button>
                    </div>
                </div>
            }
        </>
